...
public interface IStrategyService
{
    ...
    /// <summary>Strategies belonging to accounts of the given broker + type — eligible to join a portfolio.</summary>
    Task<IReadOnlyList<StrategyCandidateDto>> GetCandidatesAsync(string broker, AccountType accountType, CancellationToken ct = default);
